        ...
        <div className="max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-serif mb-6 leading-tight drop-shadow-md">
              Cruise in Comfort with <span className="text-viking-gold">Avalon Waterways</span>
            </h1>
            <p className="text-white/90 text-lg md:text-xl max-w-3xl mx-auto mb-10">Experience Europe’s most iconic rivers from the comfort of your Panorama Suite—where the views are always front and center.</p>
          </div>
          ...
          <div className="lg:col-span-5 max-w-md mx-auto lg:mx-0 transform transition-all duration-500 hover:scale-[1.02]">
            <div className="relative">
              ...
              <div className="relative z-10">
                <ContactCTA siteName="avalon-waterways" />
              </div>
            </div>
          </div>
        </div>
